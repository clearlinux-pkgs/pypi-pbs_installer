...
Source0  : https://files.pythonhosted.org/packages/0f/0c/de763ddfe6cd29cc8e48a7df9062ed387dec8dfec6bcdd6ef707f0370f38/pbs_installer-2024.9.9.tar.gz
...
%prep
%setup -q -n pbs_installer-2024.9.9
cd %{_builddir}/pbs_installer-2024.9.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726019206
