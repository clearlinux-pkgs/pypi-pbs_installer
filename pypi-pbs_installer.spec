...
Source0  : https://files.pythonhosted.org/packages/8b/67/365929546365e5fc69e090eeb5c1646bae6a8549d4d66959699e8d620562/pbs_installer-2025.3.17.tar.gz
...
%prep
%setup -q -n pbs_installer-2025.3.17
cd %{_builddir}/pbs_installer-2025.3.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742430371
