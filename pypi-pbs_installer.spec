...
Source0  : https://files.pythonhosted.org/packages/c2/5e/498bf813c4293bbecfba574e75a1957074bcd1f07ff1e5ff68723d50dea3/pbs_installer-2025.1.6.tar.gz
...
%prep
%setup -q -n pbs_installer-2025.1.6
cd %{_builddir}/pbs_installer-2025.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736272070
